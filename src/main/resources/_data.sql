...
('Jon', '123', 'jon@mail.com'), ('Sema', '789', 'sema@mail.ru');

INSERT INTO orders (create_time, amount, user_id bigint) VALUES ('2023-05-02', 30500, 1);
INSERT INTO items (order_id, cert_id, quantity) VALUES (1,4,1), (1,6,1), (1,3,2);

INSERT INTO orders (create_time, amount, user_id bigint) VALUES ('2023-05-02', 21000, 2);
INSERT INTO items (order_id, cert_id, quantity) VALUES (2,4,1), (2,6,1), (2,3,1);

INSERT INTO orders (create_time, amount, user_id bigint) VALUES ('2023-05-03', 21500, 2);
INSERT INTO items (order_id, cert_id, quantity) VALUES (3,5,2), (3,5,1), (3,6,1);

INSERT INTO orders (create_time, amount, user_id bigint) VALUES ('2023-05-03', 44000, 2);
INSERT INTO items (order_id, cert_id, quantity) VALUES (4,1,1), (4,2,1), (4,4,1); (4,6,1), (4,3,3);

INSERT INTO orders (create_time, amount, user_id bigint) VALUES ('2023-05-04', 17500, 3);
